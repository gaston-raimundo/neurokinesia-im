        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="rounded-xl overflow-hidden border border-warm">
              <iframe
                title="Ubicación Neurokinesia IM — Quintana 1465, Corrientes"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3539.3!2d-58.8341!3d-27.4806!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x38431ba84fb6d1a3!2sNeurokinesia+IM!5e0!3m2!1ses!2sar!4v1"
                width="100%"
                height="260"
